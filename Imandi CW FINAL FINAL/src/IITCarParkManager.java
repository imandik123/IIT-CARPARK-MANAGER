    ...
    public int vehicleOut() {                                                                                                       //this is the method to delete a vehicle
        ...
        for (int index = 0; index < parkSpots.size(); index++) {
            ...
            if (sample.getVehiclePlate().equals(vehicleRegNo)) {                                                                    //checks if sample's vehicle plate is same as the one entered by the customer
                ...
                if (vehicleType == 'C') {
                    carCount--;                                                                                                     //decreasing from car count because a car is leaving
                    ...
                    motorBikeCount--;                                                                                               //decreasing from motorbike count because a motorbike is leaving
                    ...
                    miniLorryCount--;                                                                                               //decreasing from mini lorry count because a mini lorry is leaving
                    totalSpots = totalSpots + 3;                                                                                    //if its a mini lorry or minibus , three spaces will be added to  totalSpots
                } else if (vehicleType == 'M') {
                    minibusCount--;                                                                                                //decreasing from minibus count because a  minibus  is leaving
                    totalSpots = totalSpots + 3;                                                                                  //if its a minibus , three spaces will be added to  totalSpots
                } else if (vehicleType == 'V'){
                    vanCount--;                                                                                                      //decreasing from van count because a  van  is leaving
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public void printPercentageOfVehicles() {                                                                                               //this method is used to get the percentage of each vehicle type in car park
        ...
        double carDouble = carCount;                                                                                    //inorder to do the calculation we need to take double of car count
        double vanDouble = vanCount;                                                                                    //inorder to do the calculation we need to take double of van count
        double busDouble = minibusCount;                                                                                //inorder to do the calculation we need to take double of minibus count
        double lorryDouble = miniLorryCount;                                                                            //inorder to do the calculation we need to take double of minilorry count
        double bikeDouble = motorBikeCount;                                                                             //inorder to do the calculation we need to take double of motorbike count
        double parkingSpaces = parkSpots.size();                                                                        //inorder to do the calculation we need to take double of parkSpots.size() as well

        if (carCount != 0) {
            carPerc = (carDouble/ (parkingSpaces)) * 100;                                                                                //if carCount isnt 0 this will obtain the percentage of cars
        ...
        if (vanCount != 0) {
            ...
            vanPerc = (vanDouble / (parkingSpaces)) * 100;                                                                                //if vanCount isnt 0 this will obtain the percentage of vans
        ...
        if (minibusCount != 0) {
            ...
            busPerc = (busDouble / (parkingSpaces)) * 100;                                                                            //if minibusCount isnt 0 this will obtain the percentage of minibuses
        ...
        if (miniLorryCount != 0) {
            ...
            lorPerc = (lorryDouble / (parkingSpaces)) * 100;                                                                          //if miniLorryCount isnt 0 this will obtain the percentage of mini lorries
        ...
        if (motorBikeCount != 0) {
            ...
            bikePerc = (bikeDouble/ (parkingSpaces)) * 100;                                                                         //if motorBikeCount isnt 0 this will obtain the percentage of motorbikes
